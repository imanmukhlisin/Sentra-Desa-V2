# AGENTS.md — Sentra Desa Project Instructions
...
ssh -i ~/.ssh/id_ed25519 root@45.80.181.191 "
  ...
  chmod -R 644 app/**/*.php config/*.php routes/*.php
"
```
...
## Catatan Penting
- PHP di VPS adalah 8.2.30, bukan 8.4 → selalu pakai `--ignore-platform-reqs` untuk composer
